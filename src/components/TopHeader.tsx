    ...
    <header className="border-b shadow-md sticky top-0 left-0 max-w-screen-2xl z-50 mx-auto">
      ...
      <div className="flex items-center justify-between px-4 py-4 md:px-8 lg:px-16 bg-white">
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Div Search bar for Large Screens */}
          <div className="hidden md:block relative">
            <FaSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
            <input
              type="text"
              placeholder="Search for products..."
              className="border rounded-full pl-10 pr-4 py-2 text-sm w-[140px] md:w-[170px] lg:w-[350px] focus:outline-none focus:ring focus:ring-gray-900"
            />
          </div>
