...
import ImageVisaLogo from "@/assets/images/payment-visa.png";
import ImageNayapayLogo from "@/assets/images/payment-nayapay.png";
import ImagePaypalLogo from "@/assets/images/payment-paypal.png";
import ImageApplepayLogo from "@/assets/images/payment-applepay.png";
import ImageGogglepayLogo from "@/assets/images/payment-gpay.png";
    ...
    <footer className="relative mt-32 bg-gray-100 pt-40 md:pt-32 max-w-screen-2xl mx-auto">
      ...
      <div className="absolute -top-24 left-1/2 w-full max-w-[1240px] -translate-x-1/2 px-4">
        <div className="rounded-[32px] bg-black p-6 md:p-8">
          <div className="md:flex md:items-center md:justify-between md:gap-8">
            ...
            <form onSubmit={Submited} className="flex flex-col gap-4 md:gap-6">
              ...
              <button
                type="submit"
                className="h-12 rounded-full bg-white px-8 font-medium text-black transition-colors hover:bg-gray-500"
              >
      ...
      <div className="border-t border-gray-300 py-4 sm:px-6 md:12 lg:px-20 flex flex-col md:flex-row justify-between items-center text-sm space-y-4 md:space-y-0">
        ...
        <div className="flex justify-center space-x-4">
          ...
          />
          <Image
           src={ImageApplepayLogo} 
           alt="Apple Pay" 
           className="h-8 w-auto" 
          />
          <Image
           src={ImageGogglepayLogo} 
           alt="Google Pay" 
           className="h-8 w-auto" 
          />
        </div>
