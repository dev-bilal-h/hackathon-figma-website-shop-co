    ...
    <div className={cn("flex flex-col h-full", isMobile ? "bg-white" : "")}>
      ...
      {isMobile && (
        <div className="flex items-center justify-between p-4 border-b">
          <h2 className={cn("text-xl font-medium", satoshi.className)}>
            Filters
          </h2>
          <button
            onClick={onClose}
      ...
      <div className={cn("flex-1 overflow-auto", isMobile ? "p-4" : "")}>
        ...
        <div className="space-y-6 mt-6">
            ...
            <div className="grid grid-cols-5 gap-3">
              {colors.map((color) => (
                <button
                  key={color.name}
                  className={cn(
                    "w-8 h-8 rounded-full ring-2 ring-offset-2 ring-transparent hover:ring-black focus:ring-black",
                    color.class
                  )}
          ...
          {/* Style for Dress*/}
          <div className="space-y-4">
            <h3 className={cn("font-medium", satoshi.className)}>
              Dress Style
            </h3>
            {styles.map((style) => (
              <div
